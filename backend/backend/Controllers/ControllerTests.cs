...
{
    /// <summary>
    /// Zestaw testów jednostkowych sprawdzających podstawową logikę kontrolerów.
    /// Testy korzystają z bazy danych InMemory EF Core, aby izolować logikę aplikacji.
    /// </summary>
    public class ControllerTests
    {
        ...
        public async Task Reservation_Create_Returns_Conflict_For_OverlappingReservation()
        {
            ...
            var guest = new Guest { FirstName = "A", LastName = "B", Email = "a@b.com" };
            db.Guests.Add(guest);
        ...
        public async Task Room_GetAvailable_Returns_Only_Available_Rooms()
        {
            ...
            var guest = new Guest { FirstName = "G", LastName = "H", Email = "g@h.com" };
            db.Guests.Add(guest);
            await db.SaveChangesAsync();
